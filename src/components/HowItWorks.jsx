      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
        {STEPS.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="p-8 rounded-3xl bg-canvas glass-panel fine-border-water shadow-md flex flex-col justify-between space-y-6 hover:-translate-y-1.5 transition-all duration-300 relative group"
            >
