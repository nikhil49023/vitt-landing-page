    ...
    <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {PRINCIPLES.map((item, idx) => (
          <div
            key={idx}
            className="p-8 rounded-3xl bg-canvas glass-panel fine-border-water shadow-md flex flex-col justify-between space-y-6 hover:-translate-y-1 transition-all duration-300"
          >
