      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="md:col-span-5 space-y-4">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-elemental-skySoft border border-elemental-sky/30 flex items-center justify-center text-elemental-water font-mono font-bold text-sm">
              V
            </div>
            ...
            <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-elemental-skySoft text-elemental-sky font-semibold border border-elemental-sky/30">
              v3.0.0 Sovereign Stack
            </span>
          </div>

          <p className="text-xs text-sandstone-muted font-serif italic max-w-sm leading-relaxed">
            A sovereign, local-first personal finance management (PFM) application engineered for India. 100% free of charge, zero ads, zero paywalls, zero cloud data uploads, and zero invasive SMS permissions.
          </p>

          <p className="text-[11px] text-sandstone-faint font-mono">
            Developed by <strong className="text-elemental-water">Kilani Sai Nikhil</strong> (Solo Independent Developer)
          </p>
        </div>
        ...
        <div className="md:col-span-3 space-y-3 text-xs">
          ...
          <ul className="space-y-2 text-sandstone-muted font-medium">
            <li>
              <a href="#features" className="hover:text-elemental-water transition-colors">Feature Inventory (9 Live + 2 Roadmap)</a>
            </li>
            <li>
        ...
        <div className="md:col-span-4 space-y-3 text-xs">
          ...
          <div className="space-y-2 text-sandstone-muted font-mono text-[11px]">
            ...
            >
              <BookOpen className="w-3.5 h-3.5 text-elemental-fire" /> Privacy Policy & Terms of Service
            </button>
            <button 
